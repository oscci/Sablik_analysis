...
Aim of this script is to apply the analysis described here:  
...
Original raw Doppler files from COLA are here: https://osf.io/uxdm6
...
for (t in 1:6){ #t is task}
  ...
  names(addbit)<-c('param1','param2','param3','LI.est','LIest.se','p.interact','R2','AIC','BIC')
...
summary.data<-cbind(summary.data,temp.data)
